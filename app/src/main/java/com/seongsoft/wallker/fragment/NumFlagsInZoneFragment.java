...
public class NumFlagsInZoneFragment extends Fragment {
    ...
    private class HttpNumFlagsInZoneLoadRankingTask extends AsyncTask<Void, Void, ArrayList<Ranking>> {
        ...
        protected ArrayList<Ranking> doInBackground(Void... params) {
            ...
            try {
                conn = (HttpURLConnection) new URL(HttpConst.SERVER_URL +
                        "/loadranking/numflagsinzone/index.jsp").openConnection();
